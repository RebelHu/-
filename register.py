...
def register():
    ...
    account_entry = tk.Entry(resWindow,width=21) #账号输入框
    account_entry.place(x=210, y=80)
    password_entry = tk.Entry(resWindow,width=21) #密码输入框
    ...
    address_entry = tk.Entry(resWindow, width=21)  # address输入框
    address_entry.place(x=210, y=170)
    phnumber_entry = tk.Entry(resWindow, width=21)  # 密码输入框
    phnumber_entry.place(x=210, y=200)
    email_entry = tk.Entry(resWindow, width=21)  # 账号输入框
