...
def admin():
    ...
    refu_button = tk.Button(adminWindow, text='拒绝该用户注册', background='white',command=refuse_ac).place(x=200, y=280)
    ...
    delete_button = tk.Button(adminWindow, text='删除该类型',command=delete_type).place(x=715, y=460)
